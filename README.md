...
<p>
  ...
  <a href="https://pub.dartlang.org/packages/tap_builder">
  <img src="https://img.shields.io/pub/v/tap_builder.svg">
 </a>
...
![screenshot](https://github.com/amaapp333/myandroid/raw/main/doc/tap_builder.gif)
...
(https://github.com/amaapp333/myandroid/blob/main/malieknews/lib/main.dart)
...
class MaliekNews {
  static final MaliekNews onTheGo = Maliek News(
    title: 'On The Go',
    route: '/on_the_go',
  ...
  static final MaliekNews iphone = MaliekNews(
    title: 'iPhone',
    route: '/iphone',
...
class BasicSamples {
  ...
  static final MaliekNews rect = MaliekNews(
    title: 'Rect',
    route: '/rect',
    builder: (_) => Template(
        childrenBuilder: () => [
  ...
  static final MaliekNews ellipsis = MaliekNews(
    title: 'Ellipsis',
    route: '/ellipsis',
    builder: (_) => Template(
        childrenBuilder: () => [
