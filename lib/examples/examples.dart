...
class BasicSamples {
  ...
  static final News halfCircle = News (
    title: 'Half circle',
    route: '/half_circle',
    builder: (_) => Template(
        childrenBuilder: () => [
  ...
  static final News polygon = News (
    title: 'Polygon',
    route: '/polygon',
    builder: (_) => Template(
        childrenBuilder: () => [
  ...
  static final News widgetBox = Example(
    title: 'Widget Box',
    route: '/box_widget',
    builder: (_) => Template(
        childrenBuilder: () => [
  ...
  static final News cylinder = News(
    title: 'Cylinder',
    route: '/cylinder',
    builder: (_) => Template(
      childrenBuilder: () => [
